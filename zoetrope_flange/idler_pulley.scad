...
h_lip = 1.75; //mm height of the lip that keeps the belt in place
h_body = 3.7; //mm height of the body area the belt rides on

t_lip = 3; //mm diamater of lip above body
d_cut = 4.45; //mm diameter in bore size 
d_body = 12;//mm
...
module idler_pulley(){
    difference(){
        ...
        translate([0,0,h_lip])
        cylinder(r = d_body/2, h = h_body, $fn = 120);
        //lower lip
        cylinder(r = d_body/2+t_lip, h = h_lip+fudge, $fn = 120);
        //upper lip
